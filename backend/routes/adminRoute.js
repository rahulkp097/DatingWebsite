...
import { DeleteSubscripctionPlan, UpdateSubscripctionPlan, addSubcripction, adminLogin, adminLogout, getDashboardData, getSubscripctions, getUserActivity, getUserData, userAction } from '../controllers/adminController.js'
...
router.delete("/deletesubscription/:id",adminAuthProtect,DeleteSubscripctionPlan)
