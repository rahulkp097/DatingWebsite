...
function AdminSubscriptions() {
  ...
  const [subscriptionsListApi, { isLoading }] =
    useGetSubscripctionPlansMutation();
  const [updateSubscriptionApi, { isLoading: isLoadingForUpdate }] =
    useUpdateSubscripctionPlanMutation();
          ...
          <form method="dialog">
            ...
            <div className="mb-4">
              ...
              <div>
                ...
                />
                <label htmlFor="qualificationRecommendation">
              ...
              <div>
                ...
                />
                <label htmlFor="locationRecommendation">
                  Based on Location
                </label>
              </div>
              <div>
