...
const UserProfilePage = () => {
  ...
  const [reportUserApi, { isLoading: isLoadingReportUser }] =
    useReportUserMutation();
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
              ...
              >
                  ...
                  {userData?.subscription?.planName && (
                    <span
                      className={`indicator-item badge ${
                        userData?.subscription?.planName === "Premium Plan"
                          ? "badge-secondary"
                          : "badge-primary"
                      } hidden sm:inline`}
                    >
                ...
                <div className="p-2">
                  {userData?.reports?.some(
                    (report) => report.reporter === userInfo?._id
                  ) ? (
                    <p className="text-red-600">
                      You have already Already Reported this user
                    </p>
                  ) : (
                    <>
                        ...
                        <>
                          {isLoadingShortlist ? (
                            ...
                            <button
                              ...
                              className="btn btn-neutral"
                              disabled={userInfo?.matches?.includes(
                                userData?._id
                              )}
                            >
