      ...
      <section className="relative bg-blueGray-50">
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.pexels.com/photos/935789/pexels-photo-935789.jpeg?auto=compress&cs=tinysrgb&w=1600')",
            }}
          >
            <span
              id="blackOverlay"
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Craft your unique dating persona with a captivating
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      ...
                      that special someone who shares your interests and values.
                    </p>
                  </div>
                </div>
              </div>
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Forge meaningful bonds and kindle the flames of romance
                      with our platform's seamless communication features.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-white ">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg ">
            ...
            <p>
              There's tons of singles. We're one of the biggest dating sites on
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-8">
            ...
            <img
              ...
              src="https://images.pexels.com/photos/3692738/pexels-photo-3692738.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
