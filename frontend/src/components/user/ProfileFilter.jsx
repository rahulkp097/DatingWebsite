...
const ProfileFilter = ({ profiles, onFilter }) => {
    ...
    const filterProfiles = () => {
      ...
      if (selectedGender) {
        filteredData = filteredData.filter((profile) => profile.gender === selectedGender);
      }
  
      if (selectedOccupation) {
        filteredData = filteredData.filter((profile) => profile.occupation === selectedOccupation);
      }
  
      if (selectedQualification) {
        filteredData = filteredData.filter((profile) => profile.qualification === selectedQualification);
      }
