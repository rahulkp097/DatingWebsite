      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 pt-5">
          {matchList?.map((match) => (
            <div
              key={match?._id}
              className="bg-white text-black rounded-lg border text-center"
            >
              ...
              <div className="px-4 py-2">
                <button
                  ...
                  className="h-10 px-5 m-2 text-blue-100 transition-colors duration-150 bg-blue-950 rounded-lg focus:shadow-outline hover:bg-rose-700"
                >
                  Delete Match
                </button>
              </div>
